...
png(paste0('~/Desktop/spring_2020/research/PAPER_CODE/FIG3/power_all_h_0_01_firing','.png'),
...
png(paste0('~/Desktop/spring_2020/research/PAPER_CODE/FIG3/Detection_prob_0_01','.png'),
    width = 6,height = 5.5, res=200,units='in')
...
png(paste0('~/Dropbox/Yiqun_RA_Winter_2020/ell_0_manuscript/plot_output/CI_coverage_only','.png'),
    width = 6,height = 6, res=400,units='in')
p_ci_coverage
dev.off()

png(paste0('~/Dropbox/Yiqun_RA_Winter_2020/ell_0_manuscript/plot_output/naive_CI_coverage','.png'),
    width = 6,height = 6, res=400,units='in')
p_naive_ci_coverage
dev.off()

png(paste0('~/Dropbox/Yiqun_RA_Winter_2020/ell_0_manuscript/plot_output/CI_width_only','.png'),
    width = 6,height = 6, res=400,units='in')
p_ci_width
dev.off()
...
png(paste0('~/Dropbox/Yiqun_RA_Winter_2020/ell_0_manuscript/plot_output/compare_selective_naive_CI','.png'),
    width = 12,height = 6, res= 300,units='in')

ggpubr::ggarrange(p_ci_coverage,p_naive_ci_coverage, ncol=2,common.legend = TRUE, legend = "bottom",
                  align="hv")
...
png(paste0('~/Dropbox/Yiqun_RA_Winter_2020/ell_0_manuscript/plot_output/skew_CI','.png'),
    width = 6,height = 6, res=400,units='in')
p_skew
dev.off()
...
png(paste0('~/Dropbox/Yiqun_RA_Winter_2020/ell_0_manuscript/plot_output/naive_CI_width_h_1','.png'),
    width = 6,height = 6, res=400,units='in')
p_naive_width_h_1
dev.off()


png(paste0('~/Dropbox/Yiqun_RA_Winter_2020/ell_0_manuscript/plot_output/width_naive_midpoint','.png'),
    width = 12,height = 6, res= 300,units='in')

ggpubr::ggarrange(p_naive_width_h_1,p_skew, ncol=2,common.legend = F, legend = "bottom",align = "hv")
